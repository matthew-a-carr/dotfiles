...
This directory contains ADRs for the dotfiles repo — significant technical decisions and their rationale.

New ADRs follow the template in [`000-template.md`](./000-template.md).
See [AGENTS.md](../../AGENTS.md) for when to write one and naming rules.
